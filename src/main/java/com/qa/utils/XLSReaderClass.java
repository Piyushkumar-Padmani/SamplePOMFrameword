...
public class XLSReaderClass {
	...
	public XLSReaderClass(String path) {
	...
	public boolean removeColumn(String sheetName, int colNum) {
		try {
			...
			XSSFCellStyle style = workbook.createCellStyle();
			style.setFillForegroundColor(HSSFColor.GREY_40_PERCENT.index);
//			XSSFCreationHelper createHelper = workbook.getCreationHelper(); //manually commented to remove warning from project
